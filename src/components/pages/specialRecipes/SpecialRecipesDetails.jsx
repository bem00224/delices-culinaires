...
const SpecialRecipesDetails = () => {
    const { title } = useParams();

  // Trouver l'élément correspondant
  const currentItem = fakeMenu.SpecialRecipes.find((item) => item.title === decodeURIComponent(title));
...
export default SpecialRecipesDetails;
